(live-load-config-file "packages-cs.el")
(live-load-config-file "settings-cs.el")
(live-load-config-file "appearance-cs.el")
(live-load-config-file "misc-cs.el")
;;(live-load-config-file clojure-cs)
(live-load-config-file "evil-cs.el")
(live-load-config-file "nrepl-cs.el")
(live-load-config-file "nerd-commenter-cs.el" )
(live-load-config-file "funcs-dotemacs.el")
(live-load-config-file  "bindings-dotemacs.el")
(require 'graphene)
